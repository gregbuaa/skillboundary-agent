...
Skill Boundary Mapping (SBM), a brand new frame to detect student skill subgraph (SSG) automatically.
...
- `sbm_baseline.py`: baseline algorithms
- `sbm_ours.py`: our SOTA algorithm
